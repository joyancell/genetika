...
<head>
  ...
  <title>Penjadwalan Mata Kuliah | Lupa Password</title>
...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <h5 class="lead text-center">Lupa Password</h5>
    ...
    <a href="<?php echo base_url() ?>">halaman login</a><br>
